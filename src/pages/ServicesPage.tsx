...
const services = [
  ...
  },
  {
    ...
    duration: '60/90 min',
    image: '/assets/images/massage-image.webp',
    benefitKeys: [
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-brand-navy via-[#0E5A6F] to-brand-aqua">
      ...
      <section className="relative isolate py-20 px-4 sm:py-32 text-center pt-32">
        ...
        <p className="max-w-2xl mx-auto text-lg text-white/80">{t('services.subtitle')}</p>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-lg overflow-hidden flex flex-col">
              <div className="relative overflow-hidden rounded-2xl aspect-square">
                <img
                  src="/assets/images/massage-image.webp"
                  alt="Masáže"
                  className="h-full w-full object-cover object-[50%_28%]"
                  fetchpriority="high"
                  decoding="sync"
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-center text-white mb-12">{t('services.equipment')}</h2>

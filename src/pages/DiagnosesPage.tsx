...
const DiagnosesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-brand-navy via-[#0E5A6F] to-brand-aqua">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[40vh] flex items-center justify-center bg-transparent text-white px-4 pt-24 md:pt-28">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mt-16 text-center bg-white/10 rounded-2xl p-8 backdrop-blur-sm">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-lg font-semibold text-white hover:text-white bg-blue-500 hover:bg-blue-600 px-6 py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl"
            >

...
const translations = {
  sk: {
    ...
    'homepage.hero.mainTitle': 'Pomôžem ti zbaviť sa bolestí — vďaka Špirálnej stabilizácii (SM systém)',
    'homepage.hero.mainTitle.desc': 'Vysvetlím ti jasné kroky a ukážem pohyb, ktorý dáva zmysel.',
    'homepage.hero.ctaButton': 'Objednať termín',
    'homepage.metrics.clients': 'Spokojných klientov',
    'homepage.metrics.study': 'Zvyšujem odbornosť pre lepšie výsledky',
    'homepage.metrics.study.value': 'Aktívne Štúdium',
    'homepage.metrics.success': 'Úspešnosť liečby',
    'homepage.whySmSystem.title': 'Prečo si vybrať SM systém?',
    'homepage.whySmSystem.benefit1.title': 'Zmierňuje bolesti chrbtice',
    'homepage.whySmSystem.benefit1.desc': 'Aktivuje špirálne svalové reťazce a odľahčuje chrbticu pre úľavu od bolesti.',
    'homepage.whySmSystem.benefit2.title': 'Podporuje prevenciu skoliózy',
    'homepage.whySmSystem.benefit2.desc': 'Vedie k symetrii a správnym vzorom pohybu; vhodný aj pri sklone k zakriveniu.',
    'homepage.whySmSystem.benefit3.title': 'Pre všetky vekové kategórie',
    'homepage.whySmSystem.benefit3.desc': 'Cvičenia sa prispôsobujú každému — od detí až po seniorov.',
    'homepage.about.subtitle': 'Certifikovaný špecialista SPS – SM systém',
    'homepage.about.title': 'O mne',
    'homepage.about.intro1': 'Volám sa Ctibor Koža a som certifikovaný špecialista na metódu Špirálnej stabilizácie chrbtice (SM systém).',
    'homepage.about.intro2': 'Pomáham ľuďom zbaviť sa bolestí, zlepšiť držanie tela a nájsť pohyb, ktorý dáva zmysel. Verím, že jasné vysvetlenie a jednoduché cvičenia prinášajú dlhodobý výsledok.',
    'homepage.about.more': 'Viac o mne',
    'homepage.services.title': 'Moje služby',
    'homepage.services.individual.title': 'Individuálny tréning',
    'homepage.services.individual.desc': 'Pripravím plán presne podľa tvojich potrieb.',
    'homepage.services.group.title': 'Skupinové cvičenia',
    'homepage.services.group.desc': 'Cvičíme spolu v malej skupine s mojím vedením.',
    'homepage.services.sport.title': 'Športový tréning',
    'homepage.services.sport.desc': 'Zameriam sa na výkon, stabilitu a prevenciu zranení.',
    'homepage.services.more': 'Zistiť viac',
    'homepage.testimonials.title': 'Čo hovoria moji klienti',
    'homepage.testimonials.quote1': 'Po troch mesiacoch cvičenia SM systému sa mi výrazne zlepšili bolesti chrbta. Cítim sa omnoho lepšie a mám viac energie.',
    'homepage.testimonials.author1': 'Jana K.',
    'homepage.testimonials.role1': 'Klientka',
    'homepage.testimonials.quote2': 'Skvelý prístup a účinná metóda. Odporúčam každému, kto má problémy s chrbticou.',
    'homepage.testimonials.author2': 'Peter N.',
    'homepage.testimonials.role2': 'Klient',
    'homepage.testimonials.quote3': 'SM systém mi pomohol zbaviť sa chronických bolestí. Cvičenia sú jednoduché a dajú sa robiť aj doma.',
    'homepage.testimonials.author3': 'Mária H.',
    'homepage.testimonials.role3': 'Klientka',
    'homepage.cta.title': 'Začnime spolu pracovať na tvojom zdraví',
    'homepage.cta.desc': 'Napíš mi alebo zavolaj — odpoviem do 24 hodín',
    'homepage.cta.phone': '+421 948 525 380',
    'homepage.cta.whatsapp': 'WhatsApp',
    'homepage.work.title': 'Pozrite si viac z mojej práce',
    'homepage.friends.title': 'Naši priatelia',
    'homepage.friends.desc': 'Sme radi, že môžeme zdieľať spoločnú cestu za zdravím a vzájomne sa podporovať.',
    'homepage.friends.spiralista.title': 'Spiralista',
    'homepage.friends.spiralista.desc': 'Naši priatelia zo Špirálni Stabilizace, ktorí s rovnakým zanietením šíria metódu Špirálnej stabilizácie a pomáhajú ľuďom žiť bez bolesti.',
    'homepage.friends.jablkovyraj.title': 'Jablkový raj',
    'homepage.friends.jablkovyraj.desc': 'Slovenský pestovatelia, ktorý prinášajú zdravé ovocné produkty priamo z prírody.',
    ...
    'aboutme.cert.6': 'Vertebroviscerálne Vzťahy',
    'aboutme.cert.7': 'Horná a dolná končatina',
    ...
    'services.group.desc': 'Tréningy v malej skupine pre všetkých, ktorí chcú napredovať v motivujúcom prostredí.',
    ...
    'smsystem.hero.subtitle': 'Metódu špirálovej stabilizácie vynašiel MUDr. Smíšek v roku 1979. Špirálová stabilizácia spája rehabilitačnú liečbu s prevenciou, regeneráciou a kondičným a výkonnostným tréningom s použitím jediného metodického postupu – túto kombináciu neposkytuje žiadna iná pohybová metóda.',
  ...
  en: {
    ...
    // Homepage specific translations
    'homepage.hero.mainTitle': 'I will help you get rid of pain — thanks to Spiral Stabilization (SM System)',
    'homepage.hero.mainTitle.desc': 'I will explain clear steps and show movement that makes sense.',
    'homepage.hero.ctaButton': 'Book an appointment',
    'homepage.metrics.clients': 'Satisfied clients',
    'homepage.metrics.study': 'I increase expertise for better results',
    'homepage.metrics.study.value': 'Active Study',
    'homepage.metrics.success': 'Treatment success rate',
    'homepage.whySmSystem.title': 'Why choose SM System?',
    'homepage.whySmSystem.benefit1.title': 'Relieves back pain',
    'homepage.whySmSystem.benefit1.desc': 'Activates spiral muscle chains and relieves the spine for pain relief.',
    'homepage.whySmSystem.benefit2.title': 'Supports scoliosis prevention',
    'homepage.whySmSystem.benefit2.desc': 'Leads to symmetry and correct movement patterns; also suitable for a tendency to curvature.',
    'homepage.whySmSystem.benefit3.title': 'For all age groups',
    'homepage.whySmSystem.benefit3.desc': 'Exercises are adapted to everyone — from children to seniors.',
    'homepage.about.subtitle': 'Certified SPS – SM System Specialist',
    'homepage.about.title': 'About me',
    'homepage.about.intro1': 'My name is Ctibor Koža and I am a certified specialist in the Spiral Stabilization of the Spine method (SM System).',
    'homepage.about.intro2': 'I help people get rid of pain, improve posture and find movement that makes sense. I believe that clear explanation and simple exercises bring long-term results.',
    'homepage.about.more': 'More about me',
    'homepage.services.title': 'My services',
    'homepage.services.individual.title': 'Individual training',
    'homepage.services.individual.desc': 'I will prepare a plan exactly according to your needs.',
    'homepage.services.group.title': 'Group exercises',
    'homepage.services.group.desc': 'We exercise together in a small group under my guidance.',
    'homepage.services.sport.title': 'Sports training',
    'homepage.services.sport.desc': 'I will focus on performance, stability and injury prevention.',
    'homepage.services.more': 'Find out more',
    'homepage.testimonials.title': 'What my clients say',
    'homepage.testimonials.quote1': 'After three months of SM system exercises, my back pain significantly improved. I feel much better and have more energy.',
    'homepage.testimonials.author1': 'Jana K.',
    'homepage.testimonials.role1': 'Client',
    'homepage.testimonials.quote2': 'Great approach and effective method. I recommend it to everyone who has spine problems.',
    'homepage.testimonials.author2': 'Peter N.',
    'homepage.testimonials.role2': 'Client',
    'homepage.testimonials.quote3': 'The SM system helped me get rid of chronic pain. The exercises are simple and can be done at home.',
    'homepage.testimonials.author3': 'Mária H.',
    'homepage.testimonials.role3': 'Client',
    'homepage.cta.title': 'Let\'s start working together on your health',
    'homepage.cta.desc': 'Write or call me — I will reply within 24 hours',
    'homepage.cta.phone': '+421 948 525 380',
    'homepage.cta.whatsapp': 'WhatsApp',
    'homepage.work.title': 'See more of my work',
    'homepage.friends.title': 'Our friends',
    'homepage.friends.desc': 'We are happy to share a common path to health and support each other.',
    'homepage.friends.spiralista.title': 'Spiralista',
    'homepage.friends.spiralista.desc': 'Our friends from Spiral Stabilization, who with the same enthusiasm spread the Spiral Stabilization method and help people live without pain.',
    'homepage.friends.jablkovyraj.title': 'Apple paradise',
    'homepage.friends.jablkovyraj.desc': 'Slovak growers who bring healthy fruit products directly from nature.',
    ...
    'aboutme.cert.6': 'Vertebrovisceral Relationships',
    'aboutme.cert.7': 'Upper and lower limbs',
    ...
    'services.individual.desc': 'During this training, a video documentation is created for the client as a tool for home exercise. Each video is intended exclusively for a specific client and must not be further shared.',
    ...
    'services.group.desc': 'Small group training for everyone who wants to progress in a motivating environment.',
    ...
    'services.massage.title': 'Massages - Manual techniques',
    ...
    'smsystem.hero.subtitle': 'The spiral stabilization method was invented by Dr. Smíšek in 1979. Spiral stabilization combines rehabilitation treatment with prevention, regeneration and fitness and performance training using a single methodological approach – this combination is not provided by any other movement method.',
